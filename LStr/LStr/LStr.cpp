...
// LStr.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLStrApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CLStrApp::OnAppAbout)
...
CLStrApp::CLStrApp() noexcept
{
	...
	SetAppID(_T("LStr.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CLStrApp

CLStrApp theApp;


// Инициализация CLStrApp

BOOL CLStrApp::InitInstance()
{
...
// Обработчики сообщений CLStrApp
...
void CLStrApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CLStrApp

void CLStrApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CLStrApp::LoadCustomState()
{
}

void CLStrApp::SaveCustomState()
{
}
